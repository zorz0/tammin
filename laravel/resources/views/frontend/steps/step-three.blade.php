                        ...
                        <!-- end -->
                          ...
                          <div class="col-md-6   p-3">
                            <div class="content row m-2  border border-1 rounded  justify-content-center align-items-center">
                                ...
                                <div class="col-4">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/price-list/Malath.png" alt=""
                                            srcset="" class="w-100">
                        ...
                        <!-- end -->
                           ...
                           <div class="col-md-6   p-3">
                            <div class="content row m-2  border border-1 rounded  justify-content-center align-items-center">
                                ...
                                <div class="col-4">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/price-list/Salama.png" alt=""
                                            srcset="" class="w-100">
                                    </figure>
                                </div>
                        ...
                        <!-- end -->
                           ...
                           <div class="col-md-6   p-3">
                            <div class="content row m-2  border border-1 rounded  justify-content-center align-items-center">
                                ...
                                <div class="col-4">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/price-list/GulfUnion.png" alt=""
                                            srcset="" class="w-100">
                                    </figure>
