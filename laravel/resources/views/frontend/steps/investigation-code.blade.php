    ...
    <div class="container">
        <div class="row  justify-center">
           ...
           <div >
            ...
            <h6 class="text-center">باستخدام البطاقه المنتهيه برقم 7864
                ...
                <div class="mt-3" id="input-Tasalsol">
                  ...
                  <input class="ta form-control input-of-buy" id="phid0" type="text" placeholder="رمز التحقيق"data-testid="homePhidControl" inputmode="numeric" autocomplete="off" name="id" title="" data-for="iqama_num" maxlength="10">
                </div>
