        ...
        <footer class="footer">
            <div class="container flex flex-col md:flex-row">
              <div class="w-100 md:w-2/12">
                <div class="footer-content ">
                  <div class="flex items-center justify-between">
                    <h3 class="footer-title text-white cursor-pointer md:cursor-auto">منتجاتنا</h3><button
                      class="flex md:hidden border-0 bg-transparent text-white"><svg xmlns="http://www.w3.org/2000/svg"
                        width="18" height="18" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                  ...
                  <div class="hidden md:block">
                    <ul id="fo1" class="footer-list collapse-footer">
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/"
                          target="_blank">تأمين السيارات</a></li>
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/"
                          target="_blank">التأمين الطبي</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="w-100 md:w-2/12">
                <div class="footer-content ">
                  <div class="flex items-center justify-between">
                    <h3 class="footer-title text-white cursor-pointer md:cursor-auto">المصادر</h3><button
                      class="flex md:hidden border-0 bg-transparent text-white"><svg xmlns="http://www.w3.org/2000/svg"
                        width="18" height="18" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                          d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z">
                  ...
                  <div class="block md:hidden"></div>
                  <div class="hidden md:block">
                    <ul id="fo2" class="footer-list collapse-footer">
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/car/faq"
                          target="_blank">الأسئلة الشائعة</a></li>
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/SamaPolicies"
                          target="_blank">لوائح هيئة التأمين </a></li>
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/career"
                          target="_blank">الوظائف </a></li>
                      <li class="footer-item"><a class="footer-link text-white hover:text-primary" href="/Partners"
                          target="_blank">شركاؤنا </a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="w-100 md:w-2/12">
                <div class="footer-content ">
                  <div class="flex items-center justify-between">
                    <h3 class="footer-title text-white cursor-pointer md:cursor-auto">الدعم</h3><button
                      class="flex md:hidden border-0 bg-transparent text-white"><svg xmlns="http://www.w3.org/2000/svg"
                        width="18" height="18" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                          d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z">
              ...
              <div class="w-100 md:w-2/12">
                <div class="footer-vision flex"><img src="{{ asset('frontend') }}/src/img/footer-vision-logo.svg" alt="رؤية 2030"
                    title="رؤية 2030"></div>
              </div>
              <div class="w-100 md:w-4/12">
                ...
                <div class="text-center md:text-start">
                  <p class="copyright">© تأميني 2023. جميع الحقوق محفوظة</p>
                  <p class="copyright">شركة تأميني لوساطة التأمين الالكتروني شركة شخص واحد</p>
                  <p class="copyright">تطوير وتشغيل <img src="{{ asset('frontend') }}/src/img/RasanLogo.png" width="60"></p>
                </div>
              </div>
            </div>
          </footer>
          <script src="{{ asset('frontend')}}/src/js/custom/react/index.js" defer="" type="text/javascript"></script>
        <script src="{{ asset('frontend/assets/js/jquery-3.7.1.min.js') }}"></script>
        <script src="{{ asset('frontend/assets/js/bootstrap.bundle.min.js') }}"></script>
        <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" integrity="sha384-XrMaSt2ay6GqB1Vd1cQkAwpG2rIMTcIw3OPdzI8ESK6H9y/3IY/kbV+jM4v5YPta" crossorigin="anonymous"></script>
