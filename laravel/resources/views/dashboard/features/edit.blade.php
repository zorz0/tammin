        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">تعديل الميزه</span>
                </div>
                
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{{ route('features.update',$feature->id) }}" method="post" id="form_sample_3" class="form-horizontal"
