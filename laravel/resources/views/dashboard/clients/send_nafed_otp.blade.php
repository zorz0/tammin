        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">برجاء ارسال الرقم الخاص بتطبيق نافد و مكون من رقمين </span>
                </div>
            ...
            <div class="portlet-body">
                ...
                <form action="{{ route('clients.doEvent',$client->id) }}" method="post" id="form_sample_3" class="form-horizontal"
                    ...
                    <div class="form-body">
                        ...
                        <input type="hidden" name="event" value="{{EVENT_STORE_NAFED_OTP}}">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">الرقم
