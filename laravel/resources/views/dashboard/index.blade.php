    ...
    <div class="col-lg-5 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat2 ">
            <div class="display">
                <div class="number">
                    <h3 class="font-blue-sharp">
                        <span data-counter="counterup" data-value="567">{{ $services }}</span>
                    </h3>
            ...
            <div class="progress-info">
                <div class="progress">
                    <span style="width: {{ $services }}%;" class="progress-bar progress-bar-success blue-sharp">
                        <span class="sr-only">45% grow</span>
                    </span>
                </div>
                <div class="status">
                    <div class="status-title"> grow </div>
                    <div class="status-number">{{  $services/100 }}% </div>
                </div>
            </div>
        </div>
    </div>
