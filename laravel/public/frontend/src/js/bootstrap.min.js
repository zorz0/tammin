!function(t, e) {
    ...
    n._removeElement = function(e) {
        ...
        g(e).hasClass("fade") ? (t = m.getTransitionDurationFromElement(e),
    ...
    var h, d = g.fn.button, f = ((h = p.prototype).toggle = function() {
        ...
        !o || (t = this._element.querySelector('input:not([type="hidden"])')) && ("radio" === t.type && (t.checked && this._element.classList.contains("active") ? n = !1 : (e = o.querySelector(".active")) && g(e).removeClass("active")),
        n && ("checkbox" !== t.type && "radio" !== t.type || (t.checked = !this._element.classList.contains("active")),
        g(t).trigger("change")),
        t.focus(),
        i = !1),
    ...
    g(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target
          , n = e;
        if (g(e).hasClass("btn") || (e = g(e).closest(".btn")[0]),
    ...
    g.fn.button.noConflict = function() {
        return g.fn.button = d,
        f._jQueryInterface
    }
    ;
    var _, v = "carousel", b = g.fn[v], y = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    _._addTouchEventListeners = function() {
        ...
        this._pointerEvent ? (g(this._element).on("pointerdown.bs.carousel", t),
        g(this._element).on("pointerup.bs.carousel", e),
        this._element.classList.add("pointer-event")) : (g(this._element).on("touchstart.bs.carousel", t),
    ...
    _._setActiveIndicatorElement = function(t) {
        ...
        (n = this._indicatorsElement.children[this._getItemIndex(t)]) && g(n).addClass("active"))
    }
    ,
    _._slide = function(t, e) {
        var n, i, o, s, r, a = this, l = this._element.querySelector(".active.carousel-item"), c = this._getItemIndex(l), h = e || l && this._getItemByDirection(t, l), u = this._getItemIndex(h), d = Boolean(this._interval), f = "next" === t ? (n = "carousel-item-left",
        i = "carousel-item-next",
        "left") : (n = "carousel-item-right",
        i = "carousel-item-prev",
        "right");
        h && g(h).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(h, f).isDefaultPrevented() && l && h && (this._isSliding = !0,
        d && this.pause(),
        ...
        g(this._element).hasClass("slide") ? (g(h).addClass(i),
        m.reflow(h),
        g(l).addClass(n),
        g(h).addClass(n),
        (s = parseInt(h.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
        ...
        g(l).one(m.TRANSITION_END, function() {
        ...
        }).emulateTransitionEnd(r)) : (g(l).removeClass("active"),
        g(h).addClass("active"),
        this._isSliding = !1,
    ...
    C._dataApiClickHandler = function(t) {
        ...
        !o || (e = g(o)[0]) && g(e).hasClass("carousel") && (n = r(r({}, g(e).data()), g(this).data()),
    ...
    S.show = function() {
        ...
        t && (e = g(t).not(this._selector).data("bs.collapse")) && e._isTransitioning) || (n = g.Event("show.bs.collapse"),
        g(this._element).trigger(n),
        n.isDefaultPrevented() || (t && (O._jQueryInterface.call(g(t).not(this._selector), "hide"),
        e || g(t).data("bs.collapse", null)),
        i = this._getDimension(),
        g(this._element).removeClass("collapse").addClass("collapsing"),
        this._element.style[i] = 0,
        this._triggerArray.length && g(this._triggerArray).removeClass("collapsed").attr("aria-expanded", !0),
    ...
    S._getConfig = function(t) {
        return (t = r(r({}, N), t)).toggle = Boolean(t.toggle),
    ...
    var j, P = "dropdown", x = g.fn[P], L = new RegExp("38|40|27"), R = {
        ...
        var t;
        this._element.disabled || g(this._element).hasClass("disabled") || (t = g(this._menu).hasClass("show"),
        Q._clearMenus(),
        t || this.show(!0))
    }
    ,
    j.show = function(t) {
        if (void 0 === t && (t = !1),
        !(this._element.disabled || g(this._element).hasClass("disabled") || g(this._menu).hasClass("show"))) {
            var e = {
    ...
    j.hide = function() {
        ...
        g(this._menu).toggleClass("show"),
        g(n).toggleClass("show").trigger(g.Event("hidden.bs.dropdown", t))))
    }
    ,
    j.dispose = function() {
    ...
    j._getConfig = function(t) {
        return t = r(r(r({}, this.constructor.Default), g(this._element).data()), t),
    ...
    j._getMenuElement = function() {
        var t;
        return this._menu || (t = Q._getParentFromElement(this._element)) && (this._menu = t.querySelector(".dropdown-menu")),
        this._menu
    }
    ,
    j._getPlacement = function() {
        var t = g(this._element.parentNode)
          , e = "bottom-start";
        return t.hasClass("dropup") ? e = g(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : g(this._menu).hasClass("dropdown-menu-right") && (e = "bottom-end"),
        e
    }
    ,
    ...
    j._getOffset = function() {
        ...
        return "function" == typeof this._config.offset ? t.fn = function(t) {
            return t.offsets = r(r({}, t.offsets), e._config.offset(t.offsets, e._element) || {}),
            t
        }
    ...
    Q._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new Q(this,"object" == typeof e ? e : null),
    ...
    Q._clearMenus = function(t) {
        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
            for (var e = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, i = e.length; n < i; n++) {
                var o, s, r = Q._getParentFromElement(e[n]), a = g(e[n]).data("bs.dropdown"), l = {
                    relatedTarget: e[n]
                };
                t && "click" === t.type && (l.clickEvent = t),
                a && (o = a._menu,
                !g(r).hasClass("show") || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && g.contains(r, t.target) || (s = g.Event("hide.bs.dropdown", l),
                g(r).trigger(s),
                s.isDefaultPrevented() || ("ontouchstart"in document.documentElement && g(document.body).children().off("mouseover", null, g.noop),
                e[n].setAttribute("aria-expanded", "false"),
                a._popper && a._popper.destroy(),
                g(o).removeClass("show"),
                g(r).removeClass("show").trigger(g.Event("hidden.bs.dropdown", l)))))
            }
    }
    ,
        ...
        if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || g(t.target).closest(".dropdown-menu").length) : !L.test(t.which)) && !this.disabled && !g(this).hasClass("disabled")) {
            ...
            if (n || 27 !== t.which) {
                ...
                !n || n && (27 === t.which || 32 === t.which))
                    return 27 === t.which && g(e.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
                ...
                0 !== o.length && (i = o.indexOf(t.target),
                38 === t.which && 0 < i && i--,
    ...
    B.show = function(t) {
        var e, n = this;
        this._isShown || this._isTransitioning || (g(this._element).hasClass("fade") && (this._isTransitioning = !0),
        ...
        g(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(t) {
            return n.hide(t)
        }),
    ...
    B.hide = function(t) {
        var e, n, i, o = this;
        t && t.preventDefault(),
        this._isShown && !this._isTransitioning && (e = g.Event("hide.bs.modal"),
        g(this._element).trigger(e),
        this._isShown && !e.isDefaultPrevented() && (this._isShown = !1,
        (n = g(this._element).hasClass("fade")) && (this._isTransitioning = !0),
        this._setEscapeEvent(),
        this._setResizeEvent(),
    ...
    B._showElement = function(t) {
        ...
        n ? (s = m.getTransitionDurationFromElement(this._dialog),
        g(this._dialog).one(m.TRANSITION_END, o).emulateTransitionEnd(s)) : o()
    }
    ,
    ...
    B._showBackdrop = function(t) {
        ...
        if (this._isShown && this._config.backdrop) {
            ...
            g(this._element).on("click.dismiss.bs.modal", function(t) {
            ...
            !this._isShown && this._backdrop ? (g(this._backdrop).removeClass("show"),
            e = function() {
                i._removeBackdrop(),
                t && t()
            }
            ,
            g(this._element).hasClass("fade") ? (n = m.getTransitionDurationFromElement(this._backdrop),
            g(this._backdrop).one(m.TRANSITION_END, e).emulateTransitionEnd(n)) : e()) : t && t()
    }
    ,
    ...
    var $, J = "tooltip", G = g.fn[J], Z = new RegExp("(^|\\s)bs-tooltip\\S+","g"), tt = ["sanitize", "whiteList", "sanitizeFn"], et = {
        animation: "boolean",
        template: "string",
    ...
    $.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            g(this.tip).hasClass("fade") ? (c = m.getTransitionDurationFromElement(this.tip),
            g(this.tip).one(m.TRANSITION_END, h).emulateTransitionEnd(c)) : h()
        }
    }
    ,
    $.hide = function(t) {
        ...
        s.isDefaultPrevented() || (g(o).removeClass("show"),
        "ontouchstart"in document.documentElement && g(document.body).children().off("mouseover", null, g.noop),
        this._activeTrigger.click = !1,
        this._activeTrigger.focus = !1,
        this._activeTrigger.hover = !1,
        g(this.tip).hasClass("fade") ? (n = m.getTransitionDurationFromElement(o),
        g(o).one(m.TRANSITION_END, e).emulateTransitionEnd(n)) : e(),
        this._hoverState = "")
    }
    ,
    $.update = function() {
    ...
    $.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Y(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    $._getOffset = function() {
        ...
        return "function" == typeof this.config.offset ? t.fn = function(t) {
            return t.offsets = r(r({}, t.offsets), e.config.offset(t.offsets, e.element) || {}),
            t
        }
    ...
    $._setListeners = function() {
        ...
        this.config.trigger.split(" ").forEach(function(t) {
            ...
            "click" === t ? g(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                return i.toggle(t)
            }) : "manual" !== t && (e = "hover" === t ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
            n = "hover" === t ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT,
    ...
    $._enter = function(t, e) {
        ...
        g(e.getTipElement()).hasClass("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout),
        e._hoverState = "show",
    ...
    $._getConfig = function(t) {
        ...
        t.sanitize && (t.template = Y(t.template, t.whiteList, t.sanitizeFn)),
        t
    }
    ,
    ...
    $._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (g(t).removeClass("fade"),
    ...
    rt._jQueryInterface = function(n) {
        return this.each(function() {
            var t = g(this).data("bs.tooltip")
              , e = "object" == typeof n && n;
            if ((t || !/dispose|hide/.test(n)) && (t || (t = new rt(this,e),
    ...
    ;
    var gt, mt = "scrollspy", pt = g.fn[mt], _t = {
        offset: 10,
        method: "auto",
        target: ""
    }, vt = {
    ...
    gt._getConfig = function(t) {
        var e;
        return "string" != typeof (t = r(r({}, _t), "object" == typeof t && t ? t : {})).target && m.isElement(t.target) && ((e = g(t.target).attr("id")) || (e = m.getUID(mt),
    ...
    var Et, wt = g.fn.tab, Tt = ((Et = Ct.prototype).show = function() {
        ...
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass("active") || g(this._element).hasClass("disabled") || (e = g(this._element).closest(".nav, .list-group")[0],
        n = m.getSelectorFromElement(this._element),
        e && (i = "UL" === e.nodeName || "OL" === e.nodeName ? "> li > .active" : ".active",
        ...
        r.isDefaultPrevented() || s.isDefaultPrevented() || (n && (t = document.querySelector(n)),
    ...
    Et._activate = function(t, e, n) {
        ...
        var o, s = this, r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(".active") : g(e).find("> li > .active"))[0], a = n && r && g(r).hasClass("fade");
        r && a ? (o = m.getTransitionDurationFromElement(r),
        g(r).removeClass("show").one(m.TRANSITION_END, i).emulateTransitionEnd(o)) : i()
    }
    ,
    Et._transitionComplete = function(t, e, n) {
        var i, o, s;
        e && (g(e).removeClass("active"),
        (i = g(e.parentNode).find("> .dropdown-menu .active")[0]) && g(i).removeClass("active"),
        "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)),
        g(t).addClass("active"),
        "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
        m.reflow(t),
        t.classList.contains("fade") && t.classList.add("show"),
        t.parentNode && g(t.parentNode).hasClass("dropdown-menu") && ((o = g(t).closest(".dropdown")[0]) && (s = [].slice.call(o.querySelectorAll(".dropdown-toggle")),
        g(s).addClass("active")),
    ...
    var St, Dt = g.fn.toast, kt = {
        ...
        this._config.animation ? (e = m.getTransitionDurationFromElement(this._element),
        g(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(e)) : t())
    }
    ,
    St.hide = function() {
        var t;
        this._element.classList.contains("show") && (t = g.Event("hide.bs.toast"),
    ...
    St._getConfig = function(t) {
        return t = r(r(r({}, Nt), g(this._element).data()), "object" == typeof t && t ? t : {}),
    ...
    It._jQueryInterface = function(n) {
        return this.each(function() {
            var t = g(this)
              , e = t.data("bs.toast");
            if (e || (e = new It(this,"object" == typeof n && n),
            t.data("bs.toast", e)),
            "string" == typeof n) {
                if (void 0 === e[n])
                    throw new TypeError('No method named "' + n + '"');
