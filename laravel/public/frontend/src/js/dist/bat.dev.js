...
function UET(o) {
  ...
  this.checkuetHostdocumentload = function () {
    ...
    if (n.documentLoaded || !document.body || document.readyState && document.readyState !== "interactive" && document.readyState !== "complete" && document.readyState !== "loaded" || n.deferLoad || (n.dispatchq(!0), n.documentLoaded = !0), n.documentLoaded) {
      ...
      }, n.uetConfig.consent.waitForUpdate);else if (!n.uetConfig.tcf.enabled || n.uetConfig.tcf.hasLoaded || n.uetConfig.tcf.timeoutId) {
  ...
  this.isDuplicate = function (o) {
    try {
      return !o || !o.q || _typeof(o.q) != "object" ? !1 : o.Ver !== 2 || !o.q.beaconParams || o.q.beaconParams.Ver !== 2 ? !1 : !o.q.beaconParams.ti || o.ti !== o.q.beaconParams.ti ? !1 : !0;
    } catch (n) {
      return !1;
    }
  };
  ...
  this.loadConfig = function () {
    ...
    o.hasOwnProperty("pagePid") && o.pagePid && _typeof(o.pagePid) == "object" ? this.pageLevelParams.pid = o.pagePid : o.hasOwnProperty("gtagPid") && o.gtagPid === !0 && (this.uetConfig.gtagPid = !0);
  ...
  this.push = function () {
    var n = arguments,
        ...
        r = !1;
    if (n.length === 1) {
      if (t = "event", n[0] === this.pageLoadEvt) i = [this.pageViewEvt, {}], r = !0;else {
  ...
  this._push = function (n) {
    ...
    if (n[1] instanceof Array) if (n[0] === "event") {
      ...
      if (_typeof(n[1][0]) != "object") return;

      for (i in n[1][0]) {
        this.knownParams.hasOwnProperty(i) && (this.pageLevelParams[i] = n[1][0][i], i === "pid" && this.pageLoadDispatch === !0 && (e = this.validateSubparams({
          pid: n[1][0][i]
        }, ""), e.hasOwnProperty("pid") && this.firePidEvent(e.pid)));
      }
    } else if (n[0] === "consent") {
      if (this.uetConfig.consent.enabled = !0, t = n[1][1], f = n[1][0], t === null || _typeof(t) != "object") return;
      ...
      if (t = n[1][1], f = n[1][0], t === null || _typeof(t) != "object") return;
  ...
  this.dispatchq = function (n) {
    ...
    for (n || (this.evqDispatch = !0, this.uetConfig.disableVisibilityEvents === !1 && ("onpagehide" in window) && (window.addEventListener("pageshow", this.firePageShow.bind(this)), window.addEventListener("pagehide", this.firePageHide.bind(this))), this.uetConfig.enableAutoSpaTracking === !0 && (("onpopstate" in window) && window.addEventListener("popstate", this.documentUrlChanged.bind(this, "popstate")), this.wrapHistoryMethod("pushState"), this.wrapHistoryMethod("replaceState"))), r = 0; r < this.evq.length; r++) {
      if (_typeof(this.evq[r]) == "object") {
        if (u = this.evq[r], t === "set") n && this.push(t, u);else if (t === "consent" || t === "config") n && i !== undefined && this.push(t, i, u);else if (!n) if (t === "event") {
          e = !1;
  ...
  this.getUuidV1 = function (n) {
    ...
    try {
      for (r = new Uint8Array(10), this.getRandomValues(r), i = (Date.now() + 122192928e5) * 1e4 + (r[8] + (r[9] << 8)) % 1e4, t = new Uint8Array(16), t[3] = i & 255, t[2] = i >> 8 & 255, t[1] = i >> 16 & 255, t[0] = i >> 24 & 255, i /= 4294967296, t[5] = i & 255, t[4] = i >> 8 & 255, t[7] = i >> 16 & 255, t[6] = i >> 24 & 255, u = 0; u < 8; u++) {
        t[u + 8] = r[u];
      }
  ...
  this.stringifyToRequest = function (n, t) {
    ...
    for (i in n) {
      u += _typeof(n[i]) == "object" ? this.stringifyToRequest(n[i], r + i) : r + i + "=" + n[i] + "&";
    }
  ...
  this.validateParameter = function (n, t, i) {
    ...
    switch (r.type) {
      ...
      case "object":
        _typeof(n) != "object" ? (this.helperError(r.error.replace("{p}", t)), n = "") : n = this.validateParameterObject(n, t);
        break;
  ...
  this.validateParameterArray = function (n, t) {
    for (var i = 0; i < n.length; i++) {
      _typeof(n[i]) == "object" && (n[i] = this.validateParameterObject(n[i], t));
    }
  ...
  this.evt = function (n, t, i, r) {
    ...
    if (r = r !== !1, i = i || {}, this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), _typeof(i) == "object") {
      if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), n === this.pageLoadEvt && (this.uetConfig.gtagPid === !0 && "enhanced_conversion_data" in window && (typeof enhanced_conversion_data === "undefined" ? "undefined" : _typeof(enhanced_conversion_data)) == "object" && (this.pageLevelParams.pid = {
  ...
  this.setCookie = function (n, t, i, r, u, f, e) {
    ...
    if (s = null, i > 0 && (s = new Date(), s.setTime(s.getTime() + i * 1e3)), l = new Date(), l.setTime(0), u && s != null && this.setLocalStorageBackup(n, t, i), this.domainName === null || r) {
      if (c = this.getHostname(), c && typeof c == "string" && c !== "localhost") for (h = c.split("."), o = h.pop(), h.length === 3 && Number(o) >= 0 && (h = []); h.length > 0;) {
  ...
  this.mapGtmUasProducts = function (n) {
    ...
    if (n.hasOwnProperty("ecomm_totalvalue")) {
      if (n.ecomm_pagetype = "purchase", n.ecomm_prodid = [], n.items = [], n.hasOwnProperty("transactionProducts") && n.transactionProducts instanceof Array) for (r = 0; r < n.transactionProducts.length; r++) {
        (t = n.transactionProducts[r], _typeof(t) == "object") && (i = {}, t.hasOwnProperty("sku") && (i.id = t.sku, n.ecomm_prodid.push(i.id)), t.hasOwnProperty("price") && (i.price = t.price), t.hasOwnProperty("quantity") && (i.quantity = t.quantity), n.items.push(i));
      }
  ...
  this.mapGtmEcommercePurchase = function (n) {
    ...
    if (n.hasOwnProperty("ecommerce") && _typeof(n.ecommerce) == "object") {
      if (n.ecommerce.hasOwnProperty("ecommerce") && _typeof(n.ecommerce.ecommerce) == "object" && (n.ecommerce = n.ecommerce.ecommerce), n.ecommerce.hasOwnProperty("purchase") && _typeof(n.ecommerce.purchase) == "object") t = n.ecommerce.purchase, n.ecomm_pagetype = "purchase";else if (n.ecommerce.hasOwnProperty("add") && _typeof(n.ecommerce.add) == "object") t = n.ecommerce.add, n.ecomm_pagetype = "cart";else if (n.ecommerce.hasOwnProperty("click") && _typeof(n.ecommerce.click) == "object") t = n.ecommerce.click, n.ecomm_pagetype = "product";else if (n.ecommerce.hasOwnProperty("detail") && _typeof(n.ecommerce.detail) == "object") t = n.ecommerce.detail, n.ecomm_pagetype = "product";else if (n.ecommerce.hasOwnProperty("impressions") && n.ecommerce.impressions instanceof Array) t = {
        products: n.ecommerce.impressions
      }, n.ecomm_pagetype = "other";else {
        delete n.ecommerce;
        return;
      }
      if (n.ecommerce.hasOwnProperty("currencyCode") && (n.currency = n.ecommerce.currencyCode), t.hasOwnProperty("actionField") && _typeof(t.actionField) == "object" && (t.actionField.hasOwnProperty("id") && (n.transaction_id = t.actionField.id), t.actionField.hasOwnProperty("revenue") && (n.ecomm_totalvalue = t.actionField.revenue)), t.hasOwnProperty("products") && t.products instanceof Array) for (n.ecomm_prodid = [], n.items = [], u = 0; u < t.products.length; u++) {
        (i = t.products[u], _typeof(i) == "object") && (r = {}, i.hasOwnProperty("id") && (r.id = i.id, n.ecomm_prodid.push(r.id)), i.hasOwnProperty("price") && (r.price = i.price), i.hasOwnProperty("quantity") && (r.quantity = i.quantity), n.items.push(r));
      }
      delete n.ecommerce;
    }
  };
  ...
  this.mapGtmGa4Items = function (n) {
    ...
    if (n.hasOwnProperty("ecomm_pagetype") && n.hasOwnProperty("event_value") && (n.ecomm_totalvalue = n.event_value), n.hasOwnProperty("items") && n.items instanceof Array) {
      for (n.ecomm_prodid = [], u = [], r = 0; r < n.items.length; r++) {
        (t = n.items[r], _typeof(t) == "object") && (i = {}, (t.item_id || t.id) && (i.id = t.item_id || t.id, n.ecomm_prodid.push(i.id)), t.hasOwnProperty("price") && (i.price = t.price), t.hasOwnProperty("quantity") && (i.quantity = t.quantity), u.push(i));
      }
...
function UET_init(u, o) {
  (_typeof(window[u]) != "object" || Object.prototype.toString.call(window[u]) === "[object Array]") && (o.q = window[u], window[u] = new UET(o));
}
...
//# sourceMappingURL=bat.dev.js.map
