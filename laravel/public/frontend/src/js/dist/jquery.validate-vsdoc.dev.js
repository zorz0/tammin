  ...
  $.extend($.validator, {
    ...
    prototype: {
      ...
      check: function check(element) {
        element = this.clean(element); // if radio/checkbox, validate first element in group instead
      ...
      showLabel: function showLabel(element, message) {
        ...
        if (label.length) {
          ...
          label.removeClass().addClass(this.settings.errorClass); // check if we have a generated label, replace the message then
    ...
    methods: {
      ...
      creditcard: function creditcard(value, element) {
        if (this.optional(element)) return "dependency-mismatch"; // accept only digits and dashes
...
//# sourceMappingURL=jquery.validate-vsdoc.dev.js.map
